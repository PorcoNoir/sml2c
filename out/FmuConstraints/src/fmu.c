...
fmi3Status fmi3GetFloat64(fmi3Instance instance,
    ...
    for (size_t i = 0; i < nvr; i++) {
        switch (vr[i]) {
        case 1: values[i] = c->data.force; break;
        case 2: values[i] = c->data.velocity; break;
        case 3: values[i] = c->data.power; break;
...
fmi3Status fmi3SetFloat64(fmi3Instance instance,
    ...
    for (size_t i = 0; i < nvr; i++) {
        switch (vr[i]) {
        case 1: c->data.force = values[i]; break;
        case 2: c->data.velocity = values[i]; break;
        case 3: c->data.power = values[i]; break;
        default: return fmi3Error;
        }
    }
    return fmi3OK;
